      ...
      FASILITAS_DESA.forEach((item) => {
        const getIconSVG = (iconName) => {
          switch (iconName) {
            ...
            case 'ph-cross':
              return '<svg width="18" height="18" viewBox="0 0 256 256" fill="currentColor"><path d="M208,80H160V32a16,16,0,0,0-16-16H112a16,16,0,0,0-16,16V80H48a16,16,0,0,0-16,16v32a16,16,0,0,0,16,16H96v80a16,16,0,0,0,16,16h32a16,16,0,0,0,16-16V144h48a16,16,0,0,0,16-16V96A16,16,0,0,0,208,80Zm0,32H144v96H112V112H48V96H112V32h32V96h64Z"/></svg>';
            case 'ph-baby':
              return '<svg width="18" height="18" viewBox="0 0 256 256" fill="currentColor"><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216ZM92,108a12,12,0,1,1,12,12A12,12,0,0,1,92,108Zm60,0a12,12,0,1,1,12,12A12,12,0,0,1,152,108Zm12.44,48a44,44,0,0,1-72.88,0,8,8,0,1,1,13.32-8.88,28,28,0,0,0,46.24,0,8,8,0,1,1,13.32,8.88Z"/></svg>';
            default:
