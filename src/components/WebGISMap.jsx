      ...
      FASILITAS_DESA.forEach((item) => {
        const getIconSVG = (iconName) => {
          switch (iconName) {
            ...
            case 'ph-tombstone':
            case 'ph-cross':
              return '<svg width="18" height="18" viewBox="0 0 256 256" fill="currentColor"><path d="M232,208H24a8,8,0,0,0,0,16H232a8,8,0,0,0,0-16ZM56,200H200V104c0-39.76-32.24-72-72-72s-72,32.24-72,72v96Zm72-152c28.68,0,52,23.32,52,52v84H76V100c0-28.68,23.32-52,52-52Zm8,32a28,28,0,1,0,0,56,20,20,0,0,1,0-56Z"/></svg>';
            case 'ph-baby':
